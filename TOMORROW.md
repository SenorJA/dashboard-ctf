...
| REST endpoints | 244 (+4: `/api/orchestrator/route`, `/api/orchestrator/specialists`, `/api/orchestrator/specialists/{name}`, `/api/orchestrator/hunt`; +2: `/api/credentials/reencrypt`, `/api/pc-analyzer/fix`) |
