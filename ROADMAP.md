...
> Última actualización: 18 Sep 2026 — MIRV v5.5 | multi-terminal SSH | notifications hub | API token auth opt-in | asset inventory per engagement | scheduler daemon + finding lifecycle | 295+ endpoints | 4790+ tests | 31 tabs | main.py 100%
