...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const toolExamples = {
        ...
        nmap: '-p 22,80,443,3306,8080 -sV -sC -O -A --min-rate=1000 -T4',
        masscan: '-p1-65535 --rate=1000 -oJ /tmp/masscan.json',
        ...
        bloodhound: '-d htb.local -u <user> -p <pass> -ns ${target} -c All',
