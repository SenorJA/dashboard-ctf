...
| REST endpoints | 243 (+4: `/api/orchestrator/route`, `/api/orchestrator/specialists`, `/api/orchestrator/specialists/{name}`, `/api/orchestrator/hunt`; +1: `/api/credentials/reencrypt`) |
